...
export const L = {
  ...
  register: {
    ...
    password:          { en: 'Password',                  ar: 'كلمة المرور' },
    confirmPassword:   { en: 'Confirm Password',          ar: 'تأكيد كلمة المرور' },
    passwordPlaceholder: { en: 'Password (min 6 characters)', ar: 'كلمة المرور (٦ أحرف على الأقل)' },
    confirmPasswordPlaceholder: { en: 'Confirm Password', ar: 'تأكيد كلمة المرور' },
    fullNamePlaceholder: { en: 'Your full name',          ar: 'اسمك الكامل' },
    agePlaceholder:    { en: 'Age',                       ar: 'العمر' },
    churchStage:       { en: 'Church Stage',              ar: 'مرحلة الكنيسة' },
    selectTenant:      { en: 'Select Tenant',             ar: 'اختر الكنيسة' },
    role:              { en: 'Role',                      ar: 'الدور' },
    adminRole:         { en: 'Admin',                     ar: 'أمين مرحلة' },
    superuserRole:     { en: 'Superuser',                 ar: 'خادم' },
    // error/success messages
    failedToSendCode:  { en: 'Failed to send code',       ar: 'فشل إرسال الرمز' },
    invalidOrExpiredCode: { en: 'Invalid or expired code', ar: 'رمز غير صالح أو منتهي' },
    passwordsDoNotMatch: { en: 'Passwords do not match',  ar: 'كلمتا المرور غير متطابقتين' },
    registrationSuccess: { en: 'Registration successful! Waiting for admin approval…', ar: 'تم التسجيل بنجاح! في انتظار موافقة المشرف…' },
    anErrorOccurred:   { en: 'An error occurred',         ar: 'حدث خطأ' },
    registrationFailed: { en: 'Registration failed',      ar: 'فشل التسجيل' },
    loginFailed:       { en: 'Login failed',              ar: 'فشل تسجيل الدخول' },
  },
  loginErrors: {
    notRegistered:     { en: 'No account found. Please register first.', ar: 'لم يتم العثور على حساب. يرجى التسجيل أولاً.' },
    authFailed:        { en: 'Sign in failed. Please try again.',        ar: 'فشل تسجيل الدخول. يرجى المحاولة مرة أخرى.' },
    googleFailed:      { en: 'Google sign-in failed. Please try again.', ar: 'فشل تسجيل الدخول بجوجل. يرجى المحاولة مرة أخرى.' },
    failedToSendReset: { en: 'Failed to send reset email',               ar: 'فشل إرسال بريد إعادة التعيين' },
  },
  pending: {
